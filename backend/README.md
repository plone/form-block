...
Install collective.volto.formsupport with uv.

```shell
uv add collective.volto.formsupport
```
...
Generated from the [`cookieplone-templates` monorepo_addon template](https://github.com/plone/cookieplone-templates/tree/main/monorepo_addon) on 2025-11-14 13:00:05.. A special thanks to all contributors and supporters!
