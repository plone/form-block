...
[![](https://img.shields.io/badge/-Storybook-ff4785?logo=Storybook&logoColor=white&style=flat-square)](https://plone.github.io/volto-form-block/)
...
Add `@plone/volto-form-block` to your `volto.config.js`.
...
```javascript
const theme = '@plone/volto-form-block';
```
...
yo @plone/volto my-volto-project --addon @plone/volto-form-block
cd my-volto-project
```
